webpackJsonpCoveo__temporary([36,65],{
...
var PrintableUri = /** @class */ (function (_super) {
    ...
    PrintableUri.prototype.buildEllipsis = function (action) {
        var button = Dom_1.$$('button', { type: 'button' }, '...');
        var element = Dom_1.$$('span', {
            className: 'coveo-printable-uri-ellipsis',
            role: 'listitem'
        }, button).el;
        new AccessibleButton_1.AccessibleButton().withElement(button).withLabel(Strings_1.l('CollapsedUriParts')).withSelectAction(action).build();
        return element;
    };
...
//# sourceMappingURL=PrintableUri__d2b01b0f173a0c131e66.js.map