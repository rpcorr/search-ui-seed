...
var CommerceQuery = /** @class */ (function (_super) {
    ...
    function CommerceQuery(element, options, bindings) {
        ...
        _this.bind.onRootElement(OmniboxEvents_1.OmniboxEvents.buildingQuerySuggest, _this.handleBuildingQuerySuggest);
    ...
    CommerceQuery.prototype.handleBuildingQuerySuggest = function (event) {
        if (this.options.listing) {
...
//# sourceMappingURL=CommerceQuery__d2b01b0f173a0c131e66.js.map